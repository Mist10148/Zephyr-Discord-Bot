...
export function GuildAI() {
  ...
  return <main className="app"><GuildShell guildId={guildId}><LargeTitleHeader title="AI" subtitle="Personas, quota and channel memory."/><p className="muted">Only messages sent to Zephyr and its replies are retained as channel memory.</p>
