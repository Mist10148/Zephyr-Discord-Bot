...
The bot is written in Python 3.13 using `discord.py`, exposes **103 slash commands** (including aliases) and **13 prefix commands**, and runs on Windows, macOS, or Linux. It can be run locally, in Docker, or deployed to cloud platforms such as Render, Heroku, AWS, and Vercel.
...
### 7.1 Slash commands (103 total, including aliases)
...
- **Slash commands:** 103 (including aliases)
- **Prefix commands:** 13
- **Cogs:** 6
